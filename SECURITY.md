...
We take the security of the `FULLSTACKS Add-on for Exoscale` seriously.
...
3. **Use a descriptive subject line** such as "SA-Exoscale_fs Security Vulnerability: [Brief Description]"
...
Only the latest release of `FULLSTACKS Add-on for Exoscale` receives security updates.
...
security issues.
Thank you for helping keep the `FULLSTACKS Add-on for Exoscale` and its users secure!
